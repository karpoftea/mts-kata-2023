...
Студент->ОбразовательнаяПлатформа: запрос курсов, куда записан
ОбразовательнаяПлатформа->APIGateway: проверка роли, перенаправление запроса
...
APIGateway->ОбразовательнаяПлатформа: курсы и статусы
ОбразовательнаяПлатформа->Студент: отображает курсы этого студента и статусы их прохождения

loop сколько подготовил работ этот студент

Студент->Студент: найти пройденный курс, по которому выполнил работу

Студент->ОбразовательнаяПлатформа: выбрать этот курс
ОбразовательнаяПлатформа->Студент: отображает пройденный курс и команду загрузки выполненной работы

Студент->ОбразовательнаяПлатформа: загрузка выполненной работы [файл]
ОбразовательнаяПлатформа->ОбразовательнаяПлатформа: прием файла, проверка формата
ОбразовательнаяПлатформа->APIGateway: проверка роли, перенаправление запроса
...
CourseManager->APIGateway: ok
APIGateway->ОбразовательнаяПлатформа: информация, что работа принята на проверку
ОбразовательнаяПлатформа->Студент: отображает информацию, что работа принята на проверку
...
Преподаватель->ПанельУправления: запрос курсов, куда назначен
ПанельУправления->APIGateway: проверка роли, перенаправление запроса
...
APIGateway->ПанельУправления: курсы и статусы
ПанельУправления->Преподаватель: отображает курсы этого преподавателя и статусы их прохождения студентами

Преподаватель->Преподаватель: найти курс, работы по которому необходимо проверить

Преподаватель->ПанельУправления: выбрать этот курс

loop сколько сейчас выполненных работ по этому курсу

ПанельУправления->Преподаватель: отображает какие работы необходимо проверить

Преподаватель->Преподаватель: решить какую работу необходимо проверить

Преподаватель->ПанельУправления: запрос выполненной работы
ПанельУправления->APIGateway: проверка роли, перенаправление запроса
...
CourseManager->APIGateway: ok
APIGateway->ПанельУправления: выполненная работа
ПанельУправления->Преподаватель: просмотр или выгрузка выполненной работы [файл]

Преподаватель->Преподаватель: проверить и оценить работу

Преподаватель->ПанельУправления: выставить оценку
ПанельУправления->APIGateway: проверка роли, перенаправление запроса
APIGateway->CourseManager: проверка того, что преподаватель ведет этот курс, и эта работа \nникем не проверена, сохранение оценки
CourseManager->APIGateway: ok
APIGateway->ПанельУправления: информация, что работа оценена
ПанельУправления->Преподаватель: отображает информацию, что работа оценена
