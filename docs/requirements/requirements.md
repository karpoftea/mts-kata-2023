...
| Урок (вариант 2) | | Часть модуля, изучаемая студентом в течение одного занятия, содержит различные учебные материалы |
...
| Г.201 | Доступа к материалам для обучения | Учебные материалы |
