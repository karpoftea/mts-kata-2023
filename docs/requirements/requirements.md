...
| СА.003 | Хранить образовательной и полу-развлекательный контент в текстовом виде, в виде графических, медиа и офисных документов, а также в видеоформате | Управление материалами курсов | v1 |
...
|--------|---------------------------------------| ---- | ---- |
| Г.001 | Создания аккаунта пользователя из графического интерфейса (требуется указание: msisdn, email) | Персонализация | v1 |
| Г.002 | Авторизации в системе при наличии аккаунта | Персонализация | v1 |
| Г.003 | Выхода пользователя из системы, если он авторизован | Персонализация | v1 |
| Г.004 | Заявлять о своем статусе как о преподавателе или студенте | Персонализация | v1 |
| Г.101 | Просмотра описаний образовательных программ, курсов по выбранному направлению даже без авторизации | Поиск курсов | v1 |
| Г.102 | Поиска модулей, уроков по его теме, аннотации, тезисам, ключевым словам | Поиск курсов | v1 |
| Г.103 | Просмотра полу-развлекательного контента (курсов, модулей, уроков), не подразумевающего оценку заданий | Изучение курсов | v1 |
| Г.104 | Участия в онлайн активностях (в том числе воркшопах) | Онлайн-активности | v1 |
| Г.202 | Доступа к маркетинговым материалам: записанные видео доступны для просмотра в любое время | Изучение курсов | v1 |

---

| ID     | Студент должен иметь возможность             | Функциональный блок | Версия |
|--------|---------------------------------------| ---- | ---- |
| С.001 | Проходить курс (модуль), изучая модули (уроки) по очереди | Изучение курсов | v1 |
...
| С.004 | Загрузить выполненную (домашнюю) работу по уроку в систему | Домашняя работа | v1 |
| С.100 | Настраивать аккаунт пользователя из графического интерфейса (указания своего фио, даты рождения (возраста), региона, ссылки на свои страницы из соц. сетей) | Персонализация | v1 |
...
| С.201 | Доступа к материалам для обучения: конспекты, презентации доступны для скачивания по ходу прохождения курса | Изучение курсов | v1 |
| С.202 | Доступа к материалам для обучения: записанные видео доступны для просмотра по ходу прохождения курса | Изучение курсов | v1 |
| С.202 | Доступа к материалам для обучения: трансляции доступны для просмотра в онлайн | Изучение курсов | v1 |
...
| ПП.003 | Проводить воркшоп для гостей или для студентов в рамках курса | Проведение занятий | v1 |
| ПП.091 | Заполнять свой профиль для его отображения гостям | Персонализация | v1 |
...
| ПП.105 | Определяеть победителей, распределять места в конкурсах (может быть 3 места) | v1 |
...
| А.104 | Просматривать список студентов на курсах. Группировать их по различным категориям | Управление студентами | v1 |
| А.121 | Вести категории для заданных в системе признаков (добавлять, редактировать, удалять неиспользуемые категории для каждого из признаков) | Категории | v1 |
...
| А.106 | Отслеживать какие модули \ курсы \ уроки прошли студенты | Анализ поведения | v1 |
| А.108 | Рассчитывать и формировать отчет о том, сколько необходимо отчислить на благотворительность на основе конверсионных действий за отчетный период | 1 | v2 |
...
| СП.005 | Формировать учебные материалы и загружать их на портал | Управление материалами курсов | v1 |
...
| СД.101 | Возможности внедрения оплаты курсов баллами МТС (кешбек), использование в пакете "Премиум" | Монетизация | v2 |
| СД.102 | Возможности внедрения оплаты курсов дебетовой картой, интернет-деньгами и последующей монетизации контента | Монетизация | v2 |
