...
| Курс | | Конкретный образовательный курс. Все, что входит в программу обучения, лекции + допматериалы, доступные к скачиванию |
| Модуль | | Логически законченный раздел курса. Несколько уроков, объединенных по теме |
| Урок | | Часть модуля, изучаемая студентом в течение одного занятия. Материал в видео или формате лонгрид |
