...
- [Описание требований к решению](#описание-требований-к-решению)
  ...
  - [Требования к системе](#требования-к-системе)
    ...
    - [Варианты использования, возникающие при обучении](#варианты-использования-возникающие-при-обучении)
...
| Место | | То, какое место заняла работа обучающегося на конкретном курсе или воркшопе |
...
![uc course view](uc_couse_view.png)
<details>
<summary>Исходник в plantuml</summary>
...
### Варианты использования, возникающие при обучении

![uc course view](uc_edu_vars.png)
<details>
<summary>Исходник в plantuml</summary>
...
|--------|---------------------------------------| ---- | ---- |
| СА.002 | Группировать пользователей по категориям (возрасту, региону) / курсам / активностям, к которым они будут иметь доступ | Управление пользователями | v2 |
...
| СА.009 | Учитывать кол-во выданных сертификатов | Управление курсами | v2 |
...
| СА.015 | Выдавать студенту электронный сертификат в случае успешного прохождения курса | Тестирование знаний | v1 |
...
| Г.004 | Заявлять о своем статусе как о преподавателе или студенте | Управление профилем | v2 |
...
| А.104 | Просматривать список студентов на курсах. Группировать их по различным категориям | Управление курсами | v2 |
| ~~А.121~~ | Вести категории для заданных в системе признаков (добавлять, редактировать, удалять неиспользуемые категории для каждого из признаков) (можно удалить, тоже самое что СП.003) | Управление курсами | Снято |
...
| А.124 | Для пользователя назначать категории по соответсвующим признакам: специализация и т. д. | Управление пользователями | v2 |
...
| СП.003 | Управлять классификаторами: добавлять, редактировать, удалять (неиспользуемые) категории для заданных в системе признаков | Управление курсами | v1 |
| ~~СП.004~~ | Управлять структурой курсов | Управление курсами (можно удалить, тоже самое что А.101) | Снято |
| ~~СП.005~~ | Формировать учебные материалы и загружать их на портал (можно удалить, тоже самое что А.101) | Управление материалами | Снято |
...
|--------|------------------------------|-------------------------------------------|
| НФТ.0xx | | <b>Стандарты качества</b> |
...
| НФТ.012 | elasticity | Эластичность выделения вычислительных ресурсов в случае увеличения нагрузки |
